...
# 2. Create Virginia and Maryland counties as dataframes
va_counties <- tibble::tibble(
  ...
  attributes.STATE = 51  # Virginia
)

md_counties <- tibble::tibble(
  ...
  attributes.STATE = 24  # Maryland
)

# 3. Combine into a county lookup table
county_lookup <- bind_rows(va_counties, md_counties)
