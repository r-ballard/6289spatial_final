...
dc <- read_csv(paste0(data_dir,"/block_groups_dc.csv"))
va <- read_csv(paste0(data_dir,"/block_groups_va.csv"))
md <- read_csv(paste0(data_dir,"/block_groups_md.csv"))
...
osm_buildings <- read_csv(paste0(data_dir,"/building_footprints.csv"))
noaa_flood_dc <- read_csv(paste0(data_dir,"/noaa_flood_dc.csv"))

#needs to be renamed to storm_details_df to work in .rmd
#storm_data <- read_delim(paste0(data_dir,"/storm_details_dmv.csv", delim = "|"))
storm_data <- as_tibble(read_pipe_csv_gz(data_dir, "storm_details_dmv"))
